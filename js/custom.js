const itemName = document.getElementById('food-name');
const errorMessage = document.getElementById('error-message');

const getFoodItems = () => {
    fetch (`https://www.themealdb.com/api/json/v1/1/search.php?s=${itemName.value}`)
    .then (res => res.json())
